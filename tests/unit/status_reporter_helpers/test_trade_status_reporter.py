...
class TestTradeStatusReporter:
    ...
    def test_trade_opportunity_found(self, reporter, writer):
        with patch("common.status_reporter_helpers.trade_status_reporter.OpportunityReporter") as MockOpp:
    ...
    def test_trade_executed(self, reporter, writer):
        with patch("common.status_reporter_helpers.trade_status_reporter.TradeReporter") as MockTrade:
