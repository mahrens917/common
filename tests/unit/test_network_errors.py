...
class TestIsNetworkUnreachableError:
    ...
    def test_aiohttp_connector_error(self) -> None:
        ...
        error = aiohttp.ClientConnectorError(conn_key=None, os_error=OSError("Connection failed"))
    ...
    def test_aiohttp_proxy_connection_error(self) -> None:
        ...
        error = aiohttp.ClientProxyConnectionError(conn_key=None, os_error=OSError("Proxy connection failed"))
        assert is_network_unreachable_error(error) is True
