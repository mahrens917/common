...
from common.process_killer_helpers.process_discovery import query_monitor_for_processes
...
class TestQueryMonitorForProcesses:
    ...
    async def test_queries_global_monitor(self) -> None:
        ...
        with patch(
            "common.process_killer_helpers.process_discovery.process_monitor_module.get_global_process_monitor",
