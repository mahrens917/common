...
from common.kalshi_api.client_helpers.fills_operations import MarketStatusOperations
...
async def test_get_exchange_status(market_ops, mock_client):
    with patch("common.kalshi_api.client_helpers.fills_operations.validate_exchange_status_response") as mock_validate:
