...
def test_initialize():
    ...
    with (
        patch("common.kalshi_api.client_helpers.component_initializer.SessionManager") as mock_sm,
        patch("common.kalshi_api.client_helpers.component_initializer.AuthenticationHelper") as mock_auth,
        patch("common.kalshi_api.client_helpers.component_initializer.RequestBuilder") as mock_rb,
        patch("common.kalshi_api.client_helpers.component_initializer.PortfolioOperations") as mock_po,
        patch("common.kalshi_api.client_helpers.component_initializer.OrderOperations") as mock_oo,
    ):
        ...
        assert "response_parser" not in result
