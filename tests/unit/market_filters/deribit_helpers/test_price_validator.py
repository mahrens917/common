"""Tests for price validation functions in validators module."""
...
class TestValidateQuotes:
    ...
    def test_validate_quotes_returns_invalid_when_ask_zero(self) -> None:
        ...
        result = validators.validate_quotes(100.0, 0, 0.1)
    ...
    def test_validate_quotes_returns_invalid_spread_when_ask_less(self) -> None:
        ...
        result = validators.validate_quotes(100.0, 99.0, 0.1)
