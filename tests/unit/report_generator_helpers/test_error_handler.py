...
class TestReportErrorHandler(unittest.IsolatedAsyncioTestCase):
    async def test_handle_report_error_success(self):
        ...
        result = await ReportErrorHandler.handle_report_error(mock_operation, "Error Message", "Log Context")
    ...
    async def test_handle_report_error_unexpected_exception(self):
        ...
        with self.assertRaises(RuntimeError):
            await ReportErrorHandler.handle_report_error(mock_operation, "Error Message", "Log Context")
