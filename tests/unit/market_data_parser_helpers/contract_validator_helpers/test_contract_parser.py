...
class TestContractParser:
    ...
    def test_parse_instrument_delegates_to_deribit_parser(self) -> None:
        ...
        with patch("common.market_data_parser_helpers.contract_validator_helpers.contract_parser.DeribitInstrumentParser") as mock_parser:
            mock_result = MagicMock()
            mock_parser.parse_instrument.return_value = mock_result

            result = ContractParser.parse_instrument("BTC-25JAN01-100000-C", "BTC")

            mock_parser.parse_instrument.assert_called_once_with("BTC-25JAN01-100000-C", strict_symbol="BTC")
    ...
    def test_parse_instrument_passes_expected_symbol(self) -> None:
        ...
        with patch("common.market_data_parser_helpers.contract_validator_helpers.contract_parser.DeribitInstrumentParser") as mock_parser:
            ...
            mock_parser.parse_instrument.assert_called_once_with("ETH-25FEB01-3000-P", strict_symbol="ETH")
