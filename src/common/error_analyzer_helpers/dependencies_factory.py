...
def create_dependencies(service_name: str, telegram_notifier: Optional[Callable] = None) -> ErrorAnalyzerDependencies:
    """
...
def create_or_use_dependencies(
    ...
    deps = create_dependencies(service_name, telegram_notifier)
