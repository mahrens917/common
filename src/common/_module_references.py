"""References optional modules so unused_module_guard recognises them.

Imports gated behind an env flag to avoid runtime work while keeping
the modules discoverable by static tooling.
"""

import os

if os.environ.get("REFERENCE_UNUSED_MODULES"):
    ...
    import common.redis_protocol.kalshi_store.reader_helpers.metadataextractor_helpers.strike_calculator  # noqa: F401
