...
def validate_required_fields(
    data: Mapping[str, Any], required_fields: List[str], prefix: str = ""
) -> None:
    """Validate that all required fields are present in data."""

    def _error_factory(missing: list[str], payload: Mapping[str, Any]) -> ValueError:
        return ValueError(
            f"{prefix}Missing required fields: {missing}. Available fields: {list(payload.keys())}"
        )
...
def validate_string_field(
    data: Mapping[str, Any], field: str, prefix: str = "", allow_empty: bool = False
) -> None:
...
def validate_numeric_field(
    data: Mapping[str, Any], field: str, prefix: str = "", min_value: float = 0.0
) -> None:
