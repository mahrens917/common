...
def validate_required_field(hash_data: dict[str, Any], field_name: str, context: str = "") -> Any:
    ...
    if value is None:
        ...
        raise RuntimeError(f"FAIL-FAST: Missing required {field_name} field{context_suffix}. Cannot proceed with empty {field_name}.")
    return value
...
def format_utc_timestamp(timestamp: Union[str, int, float]) -> str:
