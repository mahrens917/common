...
REDIS_SOCKET_CONNECT_TIMEOUT = env_float("REDIS_SOCKET_CONNECT_TIMEOUT", or_value=_DEFAULT_CONNECT_TIMEOUT)
REDIS_SOCKET_KEEPALIVE = True  # Enable TCP keepalive
REDIS_RETRY_ON_TIMEOUT = _redis_settings.retry_on_timeout
REDIS_HEALTH_CHECK_INTERVAL = env_float("REDIS_HEALTH_CHECK_INTERVAL", or_value=_DEFAULT_HEALTH_CHECK)
