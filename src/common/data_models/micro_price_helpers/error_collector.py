...
def get_validation_errors(params: ValidationErrorParams) -> List[str]:
    ...
    try:
        errors.extend(collect_spread_errors(params.absolute_spread))
        errors.extend(collect_intensity_errors(params.i_raw))
        errors.extend(collect_micro_price_errors(params.best_bid, params.best_ask, params.p_raw))
        errors.extend(
        ...
        errors.extend(collect_basic_data_errors(params.best_bid_size, params.best_ask_size, params.option_type))
