...
def validate_micro_price_constraints(
    ...
    validate_spread_constraint(absolute_spread)
    validate_intensity_constraint(i_raw)
    validate_micro_price_bounds(best_bid, best_ask, p_raw)
    validate_bid_reconstruction(best_bid, p_raw, i_raw, absolute_spread)
    validate_ask_reconstruction(best_ask, p_raw, i_raw, absolute_spread)
    return True
